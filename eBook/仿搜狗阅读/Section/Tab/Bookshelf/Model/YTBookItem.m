...
- (instancetype) initWithBookPath:(NSString*)bookPath
{
    self = [super init];
    if (self) {
        
        NSString *lastComponent = [bookPath lastPathComponent];
        self.name = [lastComponent stringByDeletingPathExtension];
        self.fileExtension = [lastComponent pathExtension];
        self.filePath = bookPath;
        self.fileURL = [NSURL fileURLWithPath:bookPath];
